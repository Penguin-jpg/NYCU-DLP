...
class kl_annealing:
    def __init__(self, args, current_epoch=0):
        ...
        # spliting training process into M cycles,
        # each start with beta=0 and end with beta=1
        ...
        # beta is a weight to control KL regularization
        self.betas = self.frange_cycle_linear(
            self.num_epochs, 0, 1, self.cycle, self.ratio
        )
    ...
    def frange_cycle_linear(self, n_iter, start=0.0, stop=1.0, n_cycle=1, ratio=1):
        ...
        step = (stop - start) / num_used_epochs
